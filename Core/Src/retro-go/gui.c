...
void gui_draw_status(tab_t *tab)
{
    ...
    if (show_battery_percentage) {
        ...
        i18n_draw_text_line(ODROID_SCREEN_WIDTH - 58, 16, 40, header, curr_colors->sel_c, curr_colors->main_c, 1);
    }

    odroid_overlay_clock(ODROID_SCREEN_WIDTH - 74 - (show_battery_percentage ? 30 : 0), 17);
}
